...
const UserProfileDashboard = () => {
  ...
  const [userProfile, setUserProfile] = useState({
    ...
    avatar:
      "https://img.rocket.new/generatedImages/rocket_gen_img_107343614-1762274140689.png",
    avatarAlt:
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Quản lý hồ sơ cá nhân, lịch sử quét sản phẩm và routine chăm sóc da trên GlowLens"
        />
      </Helmet>
